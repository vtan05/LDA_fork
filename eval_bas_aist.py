...
def cal_motion_beat(motion_file_path):
    ...
    data_pipe = Pipeline([
        ...
        ('jtsel', JointSelector(['Spine1','Spine2','Spine3','Neck','Head',
                'Right_hip','Right_knee','Right_ankle', 'Right_foot',
                'Left_hip','Left_knee', 'Left_ankle', 'Left_foot',
                'Right_collar','Right_shoulder','Right_elbow','Right_wrist',
                'Left_collar','Left_shoulder','Left_elbow','Left_wrist'], include_root=True)),
    ...
    joint_pos = np.array(joint_pos).reshape(-1, 22, 3)
...
if __name__ == '__main__':
    directory = r"/host_data/van/LDA/results/aist_8s"
